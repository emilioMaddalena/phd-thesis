...
The hope is that well tuned, specialized control algorithms could deliver better performance when compared to the simplistic strategies commonly deployed in the field, or even compared to manual regulation when occupants are given considerable actuation power \citep{stluka2018architectures}.
