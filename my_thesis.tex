...
\cleardoublepage
\phantomsection
\addcontentsline{toc}{chapter}{Acronyms} % adds an entry to the table of contents
\printacronyms
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mainmatter
\include{main/chap1_introduction}
\include{main/chap2_kernels}
\include{main/chap3_gaussian_processes}
\include{main/chap4_pqp_nn}
%\cleardoublepage
%\part{Body 1}
